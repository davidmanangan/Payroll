...
/* harmony import */ var _service_payroll_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./service/payroll.service */ "./src/app/service/payroll.service.ts");
/* harmony import */ var _model_employee__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./model/employee */ "./src/app/model/employee.ts");
...
let AppComponent = class AppComponent {
    constructor(formBuilder, httpClient, payrollService) {
        this.formBuilder = formBuilder;
        this.httpClient = httpClient;
        this.payrollService = payrollService;
        this.title = 'PayrollUI';
        this.SERVER_URL = "http://localhost:9080/users/upload";
        this.minSalary = 0.0;
        this.maxSalary = 6000.0;
        this.orderBy = "+";
        this.sortBy = "name";
        this.currentPage = 0;
        this.pageLimit = 30;
        ...
        this.displayedColumns = ['id', 'login', 'name', 'salary'];
        this.employeeArray = [];
        this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](this.employeeArray);
    }
    ngOnInit() {
    ...
    initTable() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.payrollService.getEmployees(employeeQueryParam)
                .then((res) => {
                this.employeeArray = [];
                for (var i = 0; i < res['results'].length; i++) {
                    var row = res['results'][i];
                    this.employeeArray.push(new _model_employee__WEBPACK_IMPORTED_MODULE_6__["Employee"](row['id'], row['login'], row['name'], row['salary']));
                }
...
AppComponent.ctorParameters = () => [
    ...
    { type: _service_payroll_service__WEBPACK_IMPORTED_MODULE_5__["PayrollService"] }
];
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('submitInput', { static: false }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
], AppComponent.prototype, "submitInput", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Number)
], AppComponent.prototype, "minSalary", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Number)
], AppComponent.prototype, "maxSalary", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", String)
], AppComponent.prototype, "orderBy", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", String)
], AppComponent.prototype, "sortBy", void 0);
AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"],
        ...
        _service_payroll_service__WEBPACK_IMPORTED_MODULE_5__["PayrollService"]])
], AppComponent);
...
class Employee {
    constructor(id, login, name, salary) {
        this.id = id;
        this.login = login;
        this.name = name;
        this.salary = salary;
...
/***/ "./src/app/service/payroll.service.ts":
/*!********************************************!*\
  !*** ./src/app/service/payroll.service.ts ***!
  \********************************************/
...
let PayrollService = class PayrollService {
    ...
    getEmployees(input) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            return yield this.http.get('http://localhost:9080/users?minSalary=' + input['minSalary'] + '&maxSalary=' + input['maxSalary'] + '&offset=' + input['offset'] + '&limit=' + input['limit'] + '&sort=' + input['sort']).toPromise();
        });
    }
};
...
module.exports = __webpack_require__(/*! /Users/davidmanangan/workspaces/july-12-workspace/payroll-workspace/Payroll/src/main/js/PayrollUI/src/main.ts */"./src/main.ts");
